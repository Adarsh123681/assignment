...
import { expertiseDetails } from '../assets/expertiseDetails'

const Card = () => { 
  return (
    <>
       <h1 className='text-center md:text-left font-bold text-3xl p-3 my-4'>Expertise</h1>
      <section className='card grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-2 '>
        {
          expertiseDetails.map((ele) => {
